...
module tb_RAM6;
  ...
  begin
    // VCD dump setup
    $dumpfile("tb_RAM6.vcd");   // output file
    $dumpvars(0, tb_RAM6);         // dump all variables in tb_RAM
  end
  ...
  begin
    ...
    #10 addr_rd = 6'b0000_00; //7A
    addr_wr = 6'b1010_00;
    data_in = 8'h67;

    #10 addr_rd = 6'b0010_00; //A5
    addr_wr = 6'b1111_00;
    data_in = 8'h67;
